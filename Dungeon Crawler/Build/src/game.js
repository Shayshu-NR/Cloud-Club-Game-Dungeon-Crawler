...
maingame.test_env.prototype = {
  preload: function () {
    ...
    this.load.image("health_heart2", "../Gabrielle/src/Assets/heart2.png");
    this.load.image("ammo_fire", "../Gabrielle/src/Assets/fire.png");

    this.load.image("bpack", "../Gabrielle/src/Assets/back-pack.png");
  },
  ...
  create: function () {
    ...
    player.animations.add(
      "hurt_up",
      Phaser.Animation.generateFrameNames("hurt_up_", 1, 2, ".png"),
      2,
      true
    );
    player.animations.add(
    ...
    test.animations.add(
      "wave",
      Phaser.Animation.generateFrameNames("water_f", 1, 6, ".png"),
      5,
      true
    );
  ...
  update: function () {
    if (cursors.f.downDuration(1) && !keyReset) {
      keyReset = true;
      player.current_item = "Health_Potion"; //Test for potions, set current item to Health Potion
      if (
